...
public class Queries {
    ...
    public static final String DRIVER_FIND_BY_ID = "SELECT * FROM driver WHERE driver_id=:driver_id";
    public static final String DRIVER_SAVE = "INSERT INTO driver (name, dateStartWork, salary) VALUES (:name, :dateStartWork, :salary)";
    public static final String DRIVER_UPDATE_BY_ID = "UPDATE driver SET name=:name, dateStartWork=:dateStartWork, salary=:salary WHERE driver_id=:driver_id";
    public static final String DRIVER_DELETE_BY_ID = "DELETE FROM driver WHERE driver_id=:driver_id";
    public static final String DRIVER_FIND_NAME_BY_ID = "SELECT name FROM driver WHERE driver_id=:driver_id";
